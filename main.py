...
世界市场（无建筑门槛，随时可交易）：黄金是货币。可交易=全部可存储物资：
  ...
  黄金矿场仍是唯一「自己产金」的路，但卖物资也能换黄金（卖得越多价压得越低，分批卖更划算）。
建筑（造价金·耗木·上限）：
  ...
  补给厂 250·20木 上限=耕地 → 粮+矿=补给（入补给仓；维持1能源）
  装备厂 300·20木 上限=石油 → 矿+油=装备（维持1能源）
  兵营 350·20木 上限=耕地 维持1能源；每兵营每回合可征 1 支军队（耗 10 粮食+5 装备）
